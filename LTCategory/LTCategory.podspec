#
#  Be sure to run `pod spec lint LTCategory.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors            = { "Jason" => "ak-7755@qq.com" }
  ...
  s.source_files  = "LTCategory/LTCategoryFolder", "LTCategory/LTCategoryFolder/**/*.{h, m}"
